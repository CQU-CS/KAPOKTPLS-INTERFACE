      ...
      <el-card class="box-card" shadow="always" :body-style="{padding: '0px'}">
        <div style="margin-left: 15px;margin-right: 15px;">
          <el-table v-loading="loading" element-loading-text="拼命加载中"
            ...
            <el-table-column width="100px;" align="center" prop="truckSaleId" label="编号" sortable>
            </el-table-column>
            ...
            <el-table-column width="200px;" align="center"show-overflow-tooltip prop="truckSaleNum" label="销售数量" sortable>
            </el-table-column>
            <el-table-column width="200px;" align="center"prop="truckSalePrice" label="销售总金额" sortable>
            </el-table-column>
            <el-table-column align="center" prop="truckSaleDate" label="销售日期" sortable>
            </el-table-column>
