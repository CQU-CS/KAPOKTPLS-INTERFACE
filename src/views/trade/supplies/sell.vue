      ...
      <el-card class="box-card" shadow="always" :body-style="{padding: '0px'}">
        <div style="margin-left: 15px;margin-right: 15px;">
          <el-table v-loading="loading" element-loading-text="拼命加载中"
            ...
            <el-table-column align="center" show-overflow-tooltip prop="materialId" label="物资">
            </el-table-column>
            <el-table-column width="200px;" prop="companyId" label="公司" sortable>
            </el-table-column>
            <el-table-column width="150px;" show-overflow-tooltip prop="materialSaleDate" label="日期">
            </el-table-column>
            <el-table-column width="120px;" prop="materialSaleNum" label="数量">
            </el-table-column>
            <el-table-column show-overflow-tooltip prop="materialSalePrice" label="价格">
            </el-table-column>
            </el-table-column>
            <el-table-column show-overflow-tooltip prop="payStatus" label="交易状态">
            </el-table-column>
